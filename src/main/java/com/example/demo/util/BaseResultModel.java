...
public class BaseResultModel<T> implements Serializable {
    ...
    public BaseResultModel<T> setError(Pair<Integer, String> errorPair) {
        return setError(errorPair.getKey(), errorPair.getValue());
    }
    ...
    public static BaseResultModel of(Pair<Integer, String> errorPair) {
        return new BaseResultModel().setError(errorPair);
    }
