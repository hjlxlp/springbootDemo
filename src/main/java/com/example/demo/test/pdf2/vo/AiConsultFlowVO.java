...
public class AiConsultFlowVO {
	 ...
	 * 功能：检测类别
	 */
	private String oneLevelDetectionTypeDesc;

	/**
	 * 功能：检测类别
	 */
	private Boolean isHighRiskDisease;
	...
	private UserShopVO userShopDetailVO;
	...
	private LinkedList<AiReportItemVO> nowAiTongueList;

	private AiTreatPlanJsonVo aiTreatPlanJsonVo;
	 ...
	 * 主要表现
	 */
	private String mainPerformanceNew;

	/**
	 * 发生原因
	 */
	private String occurReasonNew;

	/**
	 * 易患病症
	 */
	private String dietaryConditioningNew;

	/**
	 * 高风险提示
	 */
	private String nutritionalMatchNew;

	/**
	 * 饮食习惯
	 */
	private String drugHealthCareNew;

	/**
	 * 饮食健康
	 */
	private String recuperatesNew;

	/**
	 * 舌象特征解析
	 */
	private String tongueFeatureAnalysis;
	 ...
	 * 舌诊描述
	 */
	private String tongueTimeDesc;

	/**
	 * 健康指数图片地址
	 */
	private String healthScoreImages;


	/**
	 * 健康趋势图片地址
	 */
	private String healthTrendImages;

	/**
	 * 检测历史
	 */
	//private List<AiConsultFlowVO> aiConsultFlowListHistory;

	/**
	 * 检测历史
	 */
	private List<AiReportItemVO> tongueFeatureAnalysisList;
